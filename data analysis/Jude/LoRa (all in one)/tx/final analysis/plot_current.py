...
# -------- CONFIG --------
CLEAN_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/LoRa (all in one)/tx/final analysis/clean data"
REPHASED_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/LoRa (all in one)/tx/final analysis/rephased data"
...
def plot_comparison(clean_data, rephased_data):
    ...
    plot_subplot(
        axes[0],
        *clean_data,
        title="Original Data Phase-aligned Average Current Trace LoRa"
    )
    ...
    plot_subplot(
        axes[1],
        *rephased_data,
        title="Rephased Data Phase-aligned Average Current Trace LoRa"
    )
