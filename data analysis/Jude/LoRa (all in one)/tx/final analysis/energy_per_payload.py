...
# ---------------- CONFIG ----------------
DATA_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/LoRa (all in one)/tx/final analysis/rephased data"

V_SUPPLY = 5.011090  # actual supply voltage
...
def plot(summary):
    ...
    ax.set_title(
        "LoRa Payload Size vs Energy Consumption"
    )
