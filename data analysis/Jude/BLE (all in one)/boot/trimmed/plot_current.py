...
# -------- CONFIG --------
DATA_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/BLE (all in one)/boot/trimmed/trimmed data"
...
def plot(t, mean, std):
    ...
    plt.title("BLE Boot Average Current Trace with idle trimmed (Mean ± Std)")
