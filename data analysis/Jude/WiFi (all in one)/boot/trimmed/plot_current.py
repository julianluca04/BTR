...
# -------- CONFIG --------
DATA_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/WiFi (all in one)/boot/trimmed/trimmed data"
...
def plot(t, mean, std):
    ...
    plt.title("WiFi Boot Average Current Trace with idle trimmed (Mean ± Std)")
