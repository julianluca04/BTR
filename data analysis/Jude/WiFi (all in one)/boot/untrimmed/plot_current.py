...
# -------- CONFIG --------
DATA_DIR = "/Users/jude/Documents/GitHub/BTR/data analysis/Jude/WiFi (all in one)/boot/untrimmed/untrimmed data"
...
def plot(t, mean, std):
    ...
    plt.title("WiFi Boot Average Current Trace (Mean ± Std)")
